...
SPARK_ENVS = {
    'spark.executor.memory': "{executer_memory}g".format(executer_memory=SPARK_EXECUTOR_MEMORY),
    'spark.executor.cores': SPARK_EXECUTOR_CORES,
    # 'spark.executor.extraClassPath': "{base_dir}/lib/hbase2hive/jars/*".format(base_dir=BASE_DIR),
}
...
for i in range(0, 10):
    ...
    # # 导入 SparkContext 和 SQLContext
    # p = Process(target=spark_submit, args=SQL_CONTEXT)
    # p.start()
    # print p.pid
